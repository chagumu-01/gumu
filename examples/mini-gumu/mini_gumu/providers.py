class FakeModelClient:
    ...
    Main Gumu uses real provider clients behind the same `complete()` shape.
    mini-gumu defaults to this fake client so the control loop is visible
    ...
    def complete(self, prompt, max_new_tokens=512, **_kwargs):
        ...
        if "Tool result:" in prompt:
            return "<final>mini-gumu read the workspace through a tool and returned a final answer.</final>"
