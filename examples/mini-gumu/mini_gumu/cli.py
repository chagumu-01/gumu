...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Gumu agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-gumu starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-gumu" / "runs")
    return Gumu(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-gumu> ").strip()
